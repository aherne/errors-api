...
- *error_type*: (mandatory) defines default exception/error originator. Must match one of const values in [ErrorType](https://github.com/aherne/errors-api/blob/master/src/ErrorType.php) enum! Example: "LOGICAL"
